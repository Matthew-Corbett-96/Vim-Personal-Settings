 NeoVim Configuration: Matthew Corbett

" General Display Settings for Neovim
let mapleader = " " "Set Leader Key
set nu               "line numbers
set rnu              "relative line numbers
set ruler            "show line local in bottom right
syntax on            "code syntax (works for some language, may need extensions)
...
set spelllang=en_us,fr_ch "Set language for the spell check
set autoread              " Auto read for spelling mistakes
...
set undodir=~/.config/nvim/undodir "Local of Undo History
set undofile                    "Enable Undo Directory
...
" ag is fast enough that CtrlP dose not need to cache
...
vnore nn <esc>
vnore NN <esc>
" Make a line a comment (only works in Vim files) (will be making a func)
nnoremap <Leader>c <S-i>" <esc>
" Undo a line comment (only works in Vim files) (will be making a func)
